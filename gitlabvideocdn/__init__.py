"""
gitlabvideocdn — GitLab CI/CD Video HLS Processor & Converter Service

GitLab CI/CD altyapısı üzerinde çalışan, Hetzner Storage Box ve SSH depolama sunucularına
